...
import {
    ToolResult, ToolInfo,
    CreateUserTokenArgs, VerifyUserTokenArgs, CreateUserArgs, UpdateUserArgs,
    DeleteUserArgs, ListUsersArgs, UpdateUserPasswordArgs, ResetUserPasswordArgs
} from '../types/index.js';
...
export function listUserTools(): ToolInfo[] {
    return userToolInfo;
}

// Handle calls for user-related tools
export async function handleUserToolCall(name: string, args: any, pb: PocketBase): Promise<ToolResult> {
    switch (name) {
        case 'create_user_token':
            return createUserToken(args as CreateUserTokenArgs, pb);
        case 'verify_user_token':
            return verifyUserToken(args as VerifyUserTokenArgs, pb);
        case 'create_user':
            return createUser(args as CreateUserArgs, pb);
        case 'update_user':
            return updateUser(args as UpdateUserArgs, pb);
        case 'delete_user':
            return deleteUser(args as DeleteUserArgs, pb);
        case 'list_users':
            return listUsers(args as ListUsersArgs, pb);
        case 'update_user_password':
            return updateUserPassword(args as UpdateUserPasswordArgs, pb);
        case 'reset_user_password':
            return resetUserPassword(args as ResetUserPasswordArgs, pb);
        default:
...
async function createUserToken(args: CreateUserTokenArgs, pb: PocketBase): Promise<ToolResult> {
...
async function verifyUserToken(args: VerifyUserTokenArgs, pb: PocketBase): Promise<ToolResult> {
...
async function createUser(args: CreateUserArgs, pb: PocketBase): Promise<ToolResult> {
...
async function updateUser(args: UpdateUserArgs, pb: PocketBase): Promise<ToolResult> {
...
async function deleteUser(args: DeleteUserArgs, pb: PocketBase): Promise<ToolResult> {
    validateRequiredParams(args, ['userId']);
...
async function listUsers(args: ListUsersArgs, pb: PocketBase): Promise<ToolResult> {
...
async function updateUserPassword(args: UpdateUserPasswordArgs, pb: PocketBase): Promise<ToolResult> {
...
async function resetUserPassword(args: ResetUserPasswordArgs, pb: PocketBase): Promise<ToolResult> {
